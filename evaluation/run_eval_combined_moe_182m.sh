#!/bin/bash
# Combined evaluation script for 182M standard MoE (top-k=1 + aux_loss) model.
...
MODEL=moe
ITER=${ITER:-60000}
CKPT_ROOT=${CKPT_ROOT:-./logs/moe_182m_lr4e4_B64_E8}
...
LM_HARNESS_RESULTS=${RESULT_ROOT}/eval_results_moe_182m_${ITER}.json
LAMBADA_LOG=${RESULT_ROOT}/eval_lambada_moe_182m_${ITER}.log
COMBINED_RESULTS=${RESULT_ROOT}/eval_combined_moe_182m_${ITER}.json
...
echo "=========================================="
echo "Combined Evaluation for 182M Standard MoE"
echo "=========================================="
