#!/bin/bash
# Combined evaluation script for 469M ReMoE model.
...
MODEL=moe
ITER=${ITER:-60000}
CKPT_ROOT=${CKPT_ROOT:-./logs/remoe_469m_lr4e4_B64_E8}
...
LM_HARNESS_RESULTS=${RESULT_ROOT}/eval_results_remoe_469m_${ITER}.json
LAMBADA_LOG=${RESULT_ROOT}/eval_lambada_remoe_469m_${ITER}.log
COMBINED_RESULTS=${RESULT_ROOT}/eval_combined_remoe_469m_${ITER}.json
...
echo "=========================================="
echo "Combined Evaluation for 469M ReMoE Model"
echo "=========================================="
