...
MODEL=moe
ITER=${ITER:-60000}
CKPT_ROOT=${CKPT_ROOT:-./logs/moe_469m_lr4e4_B64_E8}
...
LM_HARNESS_RESULTS=${RESULT_ROOT}/eval_results_moe_469m_${ITER}.json
LAMBADA_LOG=${RESULT_ROOT}/eval_lambada_moe_469m_${ITER}.log
COMBINED_RESULTS=${RESULT_ROOT}/eval_combined_moe_469m_${ITER}.json
...
echo "=========================================="
echo "Combined Evaluation for 469M Standard MoE"
echo "=========================================="
