#!/bin/bash
# Combined evaluation script for 182M Expert-Choice (EC) MoE model.
...
CKPT_ROOT=${CKPT_ROOT:-./logs/ec_182m_lr4e4_B64_E${NUM_EXPERTS}_CF${CAPACITY_FACTOR}}_CF${CAPACITY_FACTOR}}
...
LM_HARNESS_RESULTS=${RESULT_ROOT}/eval_results_ec_182m_${ITER}.json
LAMBADA_LOG=${RESULT_ROOT}/eval_lambada_ec_182m_${ITER}.log
COMBINED_RESULTS=${RESULT_ROOT}/eval_combined_ec_182m_${ITER}.json
...
echo "=========================================="
echo "Combined Evaluation for 182M EC Model"
echo "=========================================="
