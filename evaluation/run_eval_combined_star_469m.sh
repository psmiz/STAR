#!/bin/bash
# Combined evaluation script for 469M STAR MoE model.
...
LM_HARNESS_RESULTS=${RESULT_ROOT}/eval_results_star_469m_${ITER}.json
LAMBADA_LOG=${RESULT_ROOT}/eval_lambada_star_469m_${ITER}.log
COMBINED_RESULTS=${RESULT_ROOT}/eval_combined_star_469m_${ITER}.json
...
echo "=========================================="
echo "Combined Evaluation for 469M STAR Model"
echo "=========================================="
