#!/bin/bash
# bash scripts/train_llama_469m_ec.sh [gpus_per_node] [train_iters] [micro_batch_size] [num_experts] [granularity] [capacity_factor] [project_name]
# Expert-Choice routing variant of train_llama_469m_moe.sh.
...
PROJECT_NAME=${7:-"ec_469m_lr4e4_B64_E${NUM_EXPERTS}_CF${CAPACITY_FACTOR}"}
