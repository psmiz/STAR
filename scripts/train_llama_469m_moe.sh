#!/bin/bash
# bash scripts/train_llama_469m_moe.sh [gpus_per_node] [train_iters] [micro_batch_size] [num_experts] [granularity] [project_name]
...
NUM_EXPERTS=${4:-"8"}
GRANILARITY=${5:-"1"}
PROJECT_NAME=${6:-"moe_469m_lr4e4_B64_E${NUM_EXPERTS}"}
